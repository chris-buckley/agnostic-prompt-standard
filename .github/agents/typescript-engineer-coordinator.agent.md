---
name: TypeScript Engineer Coordinator
...
<constants>
AGENT_APPLY_LAST_PLAN: "ts-apply-last-plan"
AGENT_CREATE_TODO_LIST: "ts-create-todo-list"
AGENT_DERIVE_MODE: "ts-derive-mode"
AGENT_DERIVE_REPO_PROFILE: "ts-derive-repo-profile"
AGENT_GATHER_CONTEXT: "ts-gather-context"
AGENT_PLAN_REQUEST: "ts-plan-request"
AGENT_REVIEW_REQUEST: "ts-review-request"
AGENT_RUN_QUALITY_SUITE: "ts-run-quality-suite"
AGENT_RUN_TESTS: "ts-run-tests"
AGENT_VALIDATE_CHANGES: "ts-validate-changes"
AGENT_TOOLING_HELP: "ts-tooling-help"
...
TEST_PATTERN: "(?i)\\b(test|tests|jest|vitest|playwright|cypress|coverage)\\b"
...
{
  "apply_last_plan": "ts-apply-last-plan",
  "create_todo_list": "ts-create-todo-list",
  "derive_mode": "ts-derive-mode",
  "derive_repo_profile": "ts-derive-repo-profile",
  "gather_context": "ts-gather-context",
  "plan_request": "ts-plan-request",
  "review_request": "ts-review-request",
  "run_quality_suite": "ts-run-quality-suite",
  "run_tests": "ts-run-tests",
  "tooling_help": "ts-tooling-help",
  "validate_changes": "ts-validate-changes"
}
>>
</constants>
