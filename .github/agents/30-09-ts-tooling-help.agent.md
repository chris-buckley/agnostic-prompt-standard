---
name: 30-09 TypeScript Tooling Help
...
MANUAL_COMMANDS: JSON<<
{
  ...
  "e2e": {
    "script_e2e": "npm run e2e",
    "script_test_e2e": "npm run test:e2e",
...
Enable the terminal/execute tool when you want the agent to run commands like tsc, eslint, prettier/biome, vitest/jest, playwright/cypress, or npm/pnpm/yarn/bun audit.
>>
</constants>
