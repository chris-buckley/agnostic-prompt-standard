---
name: 30-06 TypeScript Review Request
...
- Prefer `import type` for type-only imports to avoid runtime imports and reduce circular dependency risk.
- Promise hygiene: avoid floating promises; ensure async errors are handled and surfaced deterministically.
- Module system consistency: avoid mixing ESM and CJS patterns; keep import style aligned with repo (`type: module` vs CJS).
