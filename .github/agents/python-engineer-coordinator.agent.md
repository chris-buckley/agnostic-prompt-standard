---
name: Python Engineer Coordinator
...
<constants>
AGENT_APPLY_LAST_PLAN: "py-apply-last-plan"
AGENT_CREATE_TODO_LIST: "py-create-todo-list"
AGENT_DERIVE_MODE: "py-derive-mode"
AGENT_DERIVE_REPO_PROFILE: "py-derive-repo-profile"
AGENT_GATHER_CONTEXT: "py-gather-context"
AGENT_PLAN_REQUEST: "py-plan-request"
AGENT_REVIEW_REQUEST: "py-review-request"
AGENT_RUN_QUALITY_SUITE: "py-run-quality-suite"
AGENT_RUN_TESTS: "py-run-tests"
AGENT_VALIDATE_CHANGES: "py-validate-changes"
AGENT_TOOLING_HELP: "py-tooling-help"
...
{
  "apply_last_plan": "py-apply-last-plan",
  "create_todo_list": "py-create-todo-list",
  "derive_mode": "py-derive-mode",
  "derive_repo_profile": "py-derive-repo-profile",
  "gather_context": "py-gather-context",
  "plan_request": "py-plan-request",
  "review_request": "py-review-request",
  "run_quality_suite": "py-run-quality-suite",
  "run_tests": "py-run-tests",
  "tooling_help": "py-tooling-help",
  "validate_changes": "py-validate-changes"
}
>>
</constants>
