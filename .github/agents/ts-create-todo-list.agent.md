---
name: TypeScript Create Todo List
...
[
  {
    "description": "Understand repository conventions and constraints and identify relevant files (tsconfig, package manager, lint/format/test tools).",
    "id": 1,
    "status": "todo",
    "title": "Gather context"
  },
  {
    "description": "Define approach, boundaries, types, errors, runtime validation, and test strategy (including React Hooks/Effects rules if applicable).",
    "id": 2,
    "status": "todo",
  ...
  {
    "description": "Add or update tests for new behavior and regressions (Jest/Vitest/Testing Library as configured).",
    "id": 5,
    "status": "todo",
    "title": "Test"
  },
  {
    "description": "Run formatting, linting, type checking (tsc), security audit, and tests to validate changes.",
    "id": 6,
    "status": "todo",
    "title": "Validate"
  },
